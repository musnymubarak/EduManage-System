...
router.put('/:id', authorize('RECEPTIONIST', 'SUPER_ADMIN', 'PRINCIPAL', 'VICE_PRINCIPAL'), todoController.updateTodo);
...
router.delete('/:id', authorize('RECEPTIONIST', 'SUPER_ADMIN'), todoController.deleteTodo);
